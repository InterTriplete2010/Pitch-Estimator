function Pitch_Detector_Analysis(path_pitch,time_start,time_end,loops_FFT,...
    handle_GUI,analysis_chosen,CL_level_ac)
    ...
    if(strcmp(curr_dir(ll).name(end-2:end),'wav') == 1)
        ...
        try
            ...
            %Upload the files       
                    ...
                    file_data = file_data(first_s:last_s,1)';
        ...
        switch analysis_chosen
            ...
            case 1
                ...
                try
                    ...
                    saveas(gcf,['Pitch_' curr_dir(ll).name(1:end-4) '_Auto_Corr_Analysis.fig'])
            ...
            case 2
                ...
                try
                    ...
                    saveas(gcf,['Pitch_' curr_dir(ll).name(1:end-4) '_Cepstrum_Analysis.fig'])
            ...
            case 3
                ...
                try
                    ...
                    saveas(gcf,['Pitch_' curr_dir(ll).name(1:end-4) '_Spectral_Analysis.fig'])
